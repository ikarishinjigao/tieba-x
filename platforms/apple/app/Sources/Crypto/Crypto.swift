...
public protocol CuidProtocol: AnyObject {
  func generateC3Aid(androidId: String, uuid: String) -> String

  func generateCuid(androidId: String) -> String
}
  ...
  CuidProtocol
{
  ...
  public func uniffiClonePointer() -> UnsafeMutableRawPointer {
    try! rustCall { uniffi_crypto_fn_clone_cuid(self.pointer, $0) }
  }

  public convenience init() {
    let pointer =
      try! rustCall {
        uniffi_crypto_fn_constructor_cuid_new(
          $0
        )
      }
  ...
  deinit {
    ...
    try! rustCall { uniffi_crypto_fn_free_cuid(pointer, $0) }
  }

  open func generateC3Aid(androidId: String, uuid: String) -> String {
    try! FfiConverterString.lift(try! rustCall {
      uniffi_crypto_fn_method_cuid_generate_c3_aid(
  ...
  open func generateCuid(androidId: String) -> String {
    try! FfiConverterString.lift(try! rustCall {
      uniffi_crypto_fn_method_cuid_generate_cuid(
        self.uniffiClonePointer(),
        FfiConverterString.lower(androidId),
        $0
      )
...
public struct FfiConverterTypeCuid: FfiConverter {
  typealias FfiType = UnsafeMutableRawPointer
  typealias SwiftType = Cuid

  public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> Cuid {
    Cuid(unsafeFromRawPointer: pointer)
  }

  public static func lower(_ value: Cuid) -> UnsafeMutableRawPointer {
    value.uniffiClonePointer()
  }

  public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Cuid {
  ...
  public static func write(_ value: Cuid, into buf: inout [UInt8]) {
...
public func FfiConverterTypeCuid_lift(_ pointer: UnsafeMutableRawPointer) throws -> Cuid {
  try FfiConverterTypeCuid.lift(pointer)
}

public func FfiConverterTypeCuid_lower(_ value: Cuid) -> UnsafeMutableRawPointer {
  FfiConverterTypeCuid.lower(value)
}
...
private var initializationResult: InitializationResult = {
  ...
  if uniffi_crypto_checksum_method_cuid_generate_c3_aid() != 40098 {
    return InitializationResult.apiChecksumMismatch
  }
  if uniffi_crypto_checksum_method_cuid_generate_cuid() != 58967 {
    return InitializationResult.apiChecksumMismatch
  }
  if uniffi_crypto_checksum_constructor_cuid_new() != 25141 {
    return InitializationResult.apiChecksumMismatch
  }
